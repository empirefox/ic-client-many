(function() {
          ...
          '<div class="panel-footer">' +
            '<form style="display:inherit" ng-submit="vm.submitFunction()">' +
              '<div class="input-group" >' +
                '<span ng-bind="to||\'?\'" class="input-group-addon"></span>' +
                ...
                '<span class="input-group-btn">' +
                  '<input ng-disabled="!to||!vm.writingMessage" type="submit" class="btn btn-sm chat-submit-button" value="{{vm.submitButtonText}}" />' +
                '</span>' +
              '</div>' +
            '</form>' +
          '</div>' +
  ...
  function ChatCtrl($scope) {
    ...
    vm.submitFunction = function() {
      if(!$scope.to||!vm.writingMessage){
          return;
      }
      $scope.submitFunction()(vm.writingMessage, vm.username, $scope.to);
      vm.writingMessage = '';
    };
